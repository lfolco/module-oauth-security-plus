...
namespace Hawksama\OauthSecurityPlus\Ui\DataProvider;
 ...
 */
class IpDataProvider extends DataProvider
{
    /**
     * @var array
     */
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[IpInterface::IP_ID]] = $item;
        }

        if ($id = $this->request->getParam(IpInterface::IP_ID)) {
